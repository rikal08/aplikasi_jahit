                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="hero-caption hero-caption2">
                                    <img src="{{ asset('LandingPage') }}/assets/img/hero/hero-icon.png" alt="" data-animation="zoomIn"
                                        data-delay="1s">
                                    <h2 data-animation="fadeInLeft" data-delay=".4s">Pemesanan Berhasil</h2>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="box">
                            <div class="box-title">
                                <h1>Pemesanan Anda Telah Berhasil <i style="color:green !important" class="fa fa-check"></i></h1>
                                <a href="{{ url('detail-pemesanan',$id) }}" style="height: 40px;padding: 10px 20px !important;"  class="btn btn-primary">Lihat Pemesanan</a>
                            </div>
                        </div>
                    </div>
                </div>
