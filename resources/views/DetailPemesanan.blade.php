                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6">
                                <div class="hero-caption hero-caption2">
                                    ...
                                    <h2 data-animation="fadeInLeft" data-delay=".4s">Detail Pemesanan #{{ $id }}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Rekening Pembayaran (BNI)</h3>
                                <h2 class="box-title">26567890 (CV. AGUS JAYA TAILOR)</h2>
                            </div>
                        </div>
                        <br><br>
                        <p>Catatan: Pastikan jumlah transfer sesuai dengan jumlah pembayaran</p>
                        <hr style="border: 2px solid black">

                        <form action="{{ url('add-pembayaran') }}" method="POST" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            <div class="form-group">
                                <label for="">No. Rekening Pengirim</label>
                                <input type="text" name="no_transaksi" hidden value="{{ $id }}">
                                <input type="number" name="no_rek" class="input-form" placeholder="Masukan Nomor Rekening Pengirim">
                            </div>
                            <div class="form-group">
                                <label for="">Nama Pemilik Rekening</label>
                                <input type="text" name="nama_rek" class="input-form" placeholder="Masukan Nama Pemilik Rekening Pengirim">
                            </div>
                            <div class="form-group">
                                <label for="">Masukan Jumlah Transfer</label>
                                <input type="number" name="jumlah" class="input-form" placeholder="Masukan Jumlah Transfer">
                            </div>
                            <div class="form-group">
                                <label for="">Upload Bukti Transfer</label>
                                <input type="file" name="foto" class="input-form" placeholder="Masukan Jumlah Transfer">
                            </div>

                            <div class="form-group">
                                <a href="" style="height: 40px;padding: 10px 20px !important;" class="btn2">Batalkan Pemesanan</a>
                                <button class="btn" type="submit" style="height: 40px;padding: 10px 20px !important;">Simpan Pembayaran</button>
                            </div>
                        </form>
                        @else
