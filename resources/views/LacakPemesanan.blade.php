                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6">
                                <div class="hero-caption hero-caption2">
                                    <img src="{{ asset('LandingPage') }}/assets/img/hero/hero-icon.png" alt="" data-animation="zoomIn"
                                        data-delay="1s">
                                    <h2 data-animation="fadeInLeft" data-delay=".4s">Lacak Pemesanan</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-8 mx-auto">
                                <form action="{{ url('cari') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="">Masukan No Transaksi</label>
                                        <input name="no_transaksi" style="width: 100%;height:40px;font-size:14px;" placeholder="Masukan Resi Pemesanan" type="text" class="form-control">
                                    </div>
                                    <button style="height: 40px;padding: 10px 20px !important" class="btn btn-primary">Cari</button>
                                </form>

                                <br><br>
                                @if (Isset($pemesanan)==true)
                                <div class="box" style="border:2px solid black;padding:15px;">
                                    <div class="box-header">
                                        <h3 class="box-title">Status Pemesanan: <b>{{ $pemesanan->status }}</b></h3>
                                        <hr>
                                    </div>
                                    <div class="box-body">
                                        <p>Nama Pelanggan: <b>{{ $pemesanan->name }}</b></p>
                                        <p>Tanggal Pemesanan: <b>{{ $pemesanan->created_at }}</b></p>
                                        <p>Total Harga: Rp. <b>{{ number_format($pemesanan->total_harga) }}</b></p>
